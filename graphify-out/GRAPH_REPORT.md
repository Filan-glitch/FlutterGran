...
- granboard_segment_map_test.dart
...
Cohesion: 0.12
Nodes (16): atc_game_screen.dart, ../../domain/atc/atc_variant.dart, game_screen.dart, IconData, icon, label, _MenuRow, names (+8 more)
...
### Community 68 - "resumable_leg_provider_test.dart"
Cohesion: 0.09
...
### Community 81 - "atc_controller.dart"
Cohesion: 0.11
...
### Community 82 - "gameRepositoryProvider"
Cohesion: 0.17
Nodes (19): _persist, _persist, legSettled, _openLeg, resumeFrom, start, atcConfigProvider, atcGameProvider (+11 more)

### Community 83 - "atc_setup_screen.dart"
Cohesion: 0.12
Nodes (16): ../../domain/atc/atc_config.dart, atcVariantLabel, createState, dispose, _Eyebrow, label, _newPlayer, onTap (+8 more)

### Community 84 - "atc_stop.dart"
Cohesion: 0.17
Nodes (11): AtcStop, _bull, clears, label, number, _numbered, ring, toString (+3 more)

### Community 85 - "reconnect_delay_test.dart"
Cohesion: 0.20
...
### Community 87 - "Around the Clock — design"
Cohesion: 0.20
...
### Community 89 - "granboard_segment_map_test.dart"
Cohesion: 0.40
Nodes (4): package:fluttergran/data/board/granboard_segment_map.dart, coords, main, parts
...
- **Why does `dart` connect `dart` to `_`, `package:fluttergran/domain/segment.dart`, `leg_state.dart`, `StatelessWidget`, `splash_screen.dart`, `dart_keypad.dart`, `dart`, `mode_stats.dart`, `match_state.dart`, `main.dart`, `atc_controller.dart`, `game_controller.dart`, `Map`, `package:flutter/material.dart`, `MainMenuScreen`, `match_controller.dart`, `List`, `package:flutter_riverpod/flutter_riverpod.dart`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `AppDatabase` connect `migration_test.dart` to `database.dart`, `resumable_leg_provider_test.dart`, `end_screen_test.dart`, `providers.dart`, `atc_widget_test.dart`, `main_menu_screen_test.dart`, `game_repository.dart`, `persistence_test.dart`, `package:flutter_test/flutter_test.dart`, `responsive_layout_test.dart`?**
