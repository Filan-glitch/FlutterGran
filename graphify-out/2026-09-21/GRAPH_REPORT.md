...
## Corpus Check
- 160 files · ~162,556 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5185 nodes · 7200 edges · 272 communities (238 shown, 34 thin omitted)
...
Cohesion: 0.03
Nodes (71): AnimationController, ColorScheme, 1, base, body, brand, build, buildTheme (+63 more)
...
Cohesion: 0.03
Nodes (67): audio/sound_player.dart, audio/training_sound.dart, ../data/board/ble_board_source.dart, ../data/board/segment_codec.dart, ../domain/checkout/checkout_table.dart, _perform, ring, allAtcLegsProvider (+59 more)

### Community 8 - "atc_widget_test.dart"
Cohesion: 0.07
Nodes (29): dart:async, package:fluttergran/main.dart, closeApp, database, keypadKey, launch, main, _modeName (+21 more)
...
Cohesion: 0.07
Nodes (26): board_source.dart, led_command.dart, BoardConnectionState, connect, connectionState, _current, currentState, disconnect (+18 more)

### Community 18 - "led_command.dart"
Cohesion: 0.06
Nodes (37): dart:typed_data, a, b, black, byNumber, c, code, colourOf (+29 more)

### Community 19 - "board_source.dart"
Cohesion: 0.07
Nodes (27): BoardConnectionState get, disconnected,
  scanning,
  connecting,, frame_assembler.dart, BleBoardSource, assembler, BoardSource, codec, connect (+19 more)
...
Cohesion: 0.05
Nodes (59): RulesDetailScreen, package:flutter_riverpod/flutter_riverpod.dart, package:flutter_test/flutter_test.dart, package:fluttergran/app/providers.dart, package:fluttergran/app/rules_topic.dart, package:fluttergran/app/screens/main_menu_screen.dart, package:fluttergran/app/screens/rules_detail_screen.dart, package:fluttergran/app/screens/rules_screen.dart (+51 more)

### Community 22 - "gray"
Cohesion: 0.11
Nodes (19): $type, $value, $type, $value, $type, $value, $type, $value (+11 more)

### Community 23 - "end_screen_test.dart"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (23): ../../domain/atc/atc_stop.dart, ../../domain/stats/mode_stats.dart, child, createState, _decimal, detail, _Empty, _Eyebrow (+15 more)
...
Cohesion: 0.09
Nodes (21): FocusNode, _addPlayer, _commit, _controller, createState, didUpdateWidget, dispose, _editing (+13 more)

### Community 29 - "main_menu_screen_test.dart"
Cohesion: 0.05
Nodes (51): GameRepository, package:drift/native.dart, package:fluttergran/app/screens/atc_game_screen.dart, package:fluttergran/app/screens/atc_setup_screen.dart, package:fluttergran/app/screens/bulling_game_screen.dart, package:fluttergran/app/screens/bulling_setup_screen.dart, package:fluttergran/app/screens/roster_screen.dart, package:fluttergran/app/screens/select_game_mode_screen.dart (+43 more)
...
Cohesion: 0.05
Nodes (38): atc_setup_screen.dart, bulling_game_screen.dart, bulling_setup_screen.dart, Color, ../../domain/game_mode.dart, game_screen.dart, IconData, icon (+30 more)
...
Cohesion: 0.08
Nodes (23): AtcStop, _bull, clears, label, number, _numbered, ring, toString (+15 more)
...
Cohesion: 0.06
Nodes (30): package:drift/drift.dart, package:fluttergran/app/game_controller.dart, package:fluttergran/domain/checkout/checkout_search.dart, package:fluttergran/domain/checkout/checkout_table.dart, package:fluttergran/domain/x01/x01_rules.dart, Set, board, container (+22 more)
...
Cohesion: 0.07
Nodes (25): AppLocalizations get, BuildContext, ../../domain/bulling/bulling_variant.dart, l10n/app_localizations.dart, l10n, L10nContext, _addPlayer, _bullseyeValue (+17 more)

### Community 52 - "frame_assembler_test.dart"
Cohesion: 0.25
Nodes (7): package:fluttergran/data/board/frame_assembler.dart, advance, bytes, call, FakeClock, main, now
...
### Community 55 - "Map"
Cohesion: 0.10
Nodes (18): checkout_search.dart, buttonCode, granboardSegmentMap, innerBullCode, missCode, outerBullCode, _ringOrder, unusedMatrixSlots (+10 more)
...
Cohesion: 0.06
Nodes (36): atc_config.dart, atc_leg_state.dart, atc_stop.dart, AtcTurn? get, int?, CurrentGameId, AtcLegState, AtcTurn (+28 more)
...
Cohesion: 0.20
Nodes (9): package:fluttergran/app/atc_controller.dart, board, container, controller, main, s, session, settle (+1 more)
...
Cohesion: 0.05
Nodes (40): AssertionError, package:fluttergran/app/bulling_controller.dart, package:fluttergran/app/lights/led_cue.dart, package:fluttergran/app/lights/led_reactions.dart, package:fluttergran/domain/atc/atc_config.dart, package:fluttergran/domain/bulling/bulling_config.dart, package:fluttergran/domain/bulling/bulling_leg_state.dart, package:fluttergran/domain/bulling/bulling_reducer.dart (+32 more)
...
Cohesion: 0.04
Nodes (56): dart:io, ThrownDart, X01RuleDartChecks, package:fluttergran/data/board/granboard_segment_map.dart, package:fluttergran/domain/atc/atc_leg_state.dart, package:fluttergran/domain/atc/atc_reducer.dart, package:fluttergran/domain/atc/atc_stop.dart, package:fluttergran/domain/atc/atc_variant.dart (+48 more)

### Community 83 - "currentGameIdProvider"
Cohesion: 0.13
Nodes (39): ConsumerWidget, build, atcLightsProvider, bullingLightsProvider, x01LightsProvider, _openLeg, atcConfigProvider, atcGameProvider (+31 more)

### Community 84 - "dart"
Cohesion: 0.06
Nodes (33): dart, big, _brandGreen, bust, command, connected, _flashFor, gameOn (+25 more)

### Community 85 - "free_practice_state.dart"
Cohesion: 0.11
Nodes (16): int get, points, three, currentTurnDarts, darts, dartsThrown, foldFreePractice, FreePracticeState (+8 more)

### Community 86 - "dart"
Cohesion: 0.07
Nodes (29): ../atc_controller.dart, ../audio/sound_controller.dart, ../bulling_controller.dart, ../../domain/checkout/checkout_search.dart, ../game_controller.dart, dart, after, all (+21 more)
...
### Community 94 - "../../domain/segment.dart"
Cohesion: 0.25
...
Cohesion: 0.09
Nodes (10): _exact_stack_identifier(), Resolve a deprecated in-domain alias, or expose a cross-domain redirect., Main search function with auto-domain detection, Resolve a standalone API identifier even when its BM25 IDF is low., search(), _style_search_destination(), TestDiagnosticsContracts, TestSearchDomains (+2 more)
...
Cohesion: 0.08
Nodes (23): ../../domain/x01/x01_rules.dart, _addPlayer, createState, dispose, _Eyebrow, _headToHead, _inRule, l10n (+15 more)
...
### Community 119 - "gameRepositoryProvider"
Cohesion: 0.11
Nodes (20): ../../domain/x01/game_config.dart, ../../domain/x01/match_state.dart, _persist, _persist, _persist, build, config, decidedLegs (+12 more)
...
Cohesion: 0.11
Nodes (17): LedScheduler, package:fluttergran/app/lights/led_scheduler.dart, package:fluttergran/app/lights/led_theme.dart, package:fluttergran/app/lights/lights_providers.dart, package:fluttergran/data/board/fake_board_source.dart, package:fluttergran/data/board/led_command.dart, big, connected (+9 more)
...
Cohesion: 0.10
Nodes (28): ConsumerState, ConsumerStatefulWidget, boardSourceProvider, playersProvider, resumableLegProvider, x01DefaultsProvider, AtcSetupScreen, _AtcSetupScreenState (+20 more)
...
Cohesion: 0.06
Nodes (38): ../data/db/game_repository.dart, ../domain/training/free_practice_state.dart, ../../domain/x01/leg_reducer.dart, ../../domain/x01/leg_state.dart, acknowledgedTurns, addDart, awaitingTurnConfirm, confirmTurn (+30 more)

### Community 192 - "get_cip_brief"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (22): ../../domain/atc/atc_config.dart, ../../domain/atc/atc_leg_state.dart, ../../domain/atc/atc_reducer.dart, acknowledgedTurns, addDart, AtcController, AtcSession, awaitingTurnConfirm (+14 more)
...
Cohesion: 0.08
Nodes (25): dart:math, ../../domain/bulling/bulling_config.dart, ../../domain/bulling/bulling_leg_state.dart, ../../domain/bulling/bulling_reducer.dart, acknowledgedTurns, addDart, awaitingTurnConfirm, BullingController (+17 more)
...
Cohesion: 0.11
Nodes (18): atc_game_screen.dart, ../../data/db/database.dart, ../../domain/atc/atc_variant.dart, _addPlayer, atcVariantLabel, createState, dispose, _Eyebrow (+10 more)
...
Cohesion: 0.09
Nodes (22): bool get, Segment, hashCode, isDouble, label, miss, operator, segment (+14 more)
...
Cohesion: 0.12
Nodes (16): _ambient, dispose, _disposed, _gateClosed, _gateTimer, isShowing, minimumGap, off (+8 more)
...
### Community 219 - "test_design_system_mode.py"
Cohesion: 0.23
...
### Community 220 - "../providers.dart"
Cohesion: 0.14
Nodes (12): ../../data/board/board_source.dart, build, _ChalkMark, createState, initState, paint, _proceed, shouldRepaint (+4 more)
...
### Community 235 - "test_data_contracts.py"
Cohesion: 0.24
...
Cohesion: 0.15
Nodes (12): ../../data/board/led_command.dart, led_cue.dart, led_reactions.dart, led_scheduler.dart, led_theme.dart, connection, _drive, enabled (+4 more)

### Community 242 - "../../domain/x01/thrown_dart.dart"
Cohesion: 0.22
Nodes (8): ../../domain/x01/thrown_dart.dart, after, before, _darts, sounds, soundsForTraining, sound_controller.dart, ../training_controller.dart
...
### Community 247 - "TrainingGameScreen"
Cohesion: 0.53
...
Cohesion: 0.33
Nodes (5): return, main, pumpBoardIn, pumpWidget, tapped
...
## Knowledge Gaps
- **3033 isolated node(s):** `XCTest`, `leg`, `acknowledgedTurns`, `awaitingTurnConfirm`, `pendingTurn` (+3028 more)
...
- **Why does `search()` connect `search` to `scripts/search.py`, `scripts/core.py`, `.generate`, `validate_data.py`, `test_text_layout_resilience.py`, `test_core.py`, `design_system.py`, `detect_domain`, `_row_identities`, `BM25`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `dart` connect `dart` to `leg_state.dart`, `mode_stats.dart`, `match_state.dart`, `package:flutter_riverpod/flutter_riverpod.dart`, `dart`, `dart_keypad.dart`, `main.dart`, `bulling_setup_screen.dart`, `Map`, `atc_leg_state.dart`, `game_controller.dart`, `List`, `dart`, `package:fluttergran/domain/segment.dart`, `currentGameIdProvider`, `dart`, `../providers.dart`, `package:flutter/material.dart`, `VoidCallback`, `x01_setup_screen.dart`, `../../domain/x01/thrown_dart.dart`, `gameRepositoryProvider`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `AppDatabase` connect `migration_test.dart` to `database.dart`, `providers.dart`, `atc_widget_test.dart`, `responsive_layout_test.dart`, `led_reactions_test.dart`, `game_repository.dart`, `persistence_test.dart`, `package:flutter_riverpod/flutter_riverpod.dart`, `end_screen_test.dart`, `main_menu_screen_test.dart`?**
